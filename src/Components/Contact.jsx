    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-600 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 grid place-items-center ring-2
              ring-zinc-50/5 rounded-lg transition-[background-color,color] 
              hover:bg-zinc-400 active:bg-zinc-50/80"
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action="https://getform.io/f/bgdyeyla"
          method="post"
